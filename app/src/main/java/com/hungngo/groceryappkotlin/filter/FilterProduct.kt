...
class FilterProduct(private var adapter: SellerProductAdapter, private var filterList: MutableList<Product>): Filter() {
    ...
    override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
        adapter.listProduct = results!!.values as MutableList<Product>
